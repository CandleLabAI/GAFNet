...
from GAFNet.task_utils import LoadDatasetEval, LoadLosses, ForwardModelsTrain, ForwardModelsVal, EvaluatingModel
from GAFNet.GAFNet import GAFNetForVLTasks, BertForMultiModalPreTraining
...
def main():
    ...
    if args.baseline:
        ...
        from GAFNet.GAFNet import BertConfig
