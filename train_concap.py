...
from GAFNet.datasets import ConceptCapLoaderTrain, ConceptCapLoaderVal
from GAFNet.GAFNet import BertForMultiModalPreTraining, BertConfig
...
def main():
    ...
    parser.add_argument(
        ...
        help="till which layer of textual stream of gafnet need to fixed."
    )
    parser.add_argument(
    ...
    if args.baseline:
        ...
        from GAFNet.basebert import BertForMultiModalPreTraining
    else:
        from GAFNet.GAFNet import BertForMultiModalPreTraining, BertConfig
