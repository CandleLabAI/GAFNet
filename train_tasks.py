...
from GAFNet.task_utils import LoadDatasets, LoadLosses, ForwardModelsTrain, ForwardModelsVal
from GAFNet.optimization import BertAdam, Adam, Adamax
from torch.optim.lr_scheduler import LambdaLR, ReduceLROnPlateau

import GAFNet.utils as utils
...
def main():
    ...
    with open('GAFNET_CONFIG.yml', 'r') as f:
    ...
    if args.baseline:
        ...
        from GAFNet.basebert import BaseBertForVLTasks
    elif args.compact:
        from GAFNet.vilbert_compact import BertConfig
        from GAFNet.vilbert_compact import GAFNetForVLTasks        
    else:
        from GAFNet.vilbert import BertConfig
        from GAFNet.vilbert import GAFNetForVLTasks
    ...
    if args.baseline:
        ...
        model = GAFNetForVLTasks.from_pretrained(
            args.from_pretrained, config, num_labels=num_labels, default_gpu=default_gpu
            )
